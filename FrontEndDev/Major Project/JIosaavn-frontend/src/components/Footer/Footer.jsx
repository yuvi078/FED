    ...
    <div className="ml-2  tertiary_bg px-8 py-16 mb-20">
      ...
      <div className="flex justify-between">
        <ul className="text-sm flex gap-4">
          <li className="text-black-400">Legal</li>
          <li className="text-black-400">Privacy Center</li>
          <li className="text-black-400">Privacy Policy</li>
          <li className="text-black-400">Cookies</li>
          <li className="text-black-400">About Ads</li>
          <li className="text-black-400">Accessibility</li>
        </ul>
        <h4 className="text-black-400 text-sm">© 2024 JioSaavn-Clone </h4>
      </div>
    </div>
  );
};
